...
const useDummyStore = create<DummyProps>((set) => ({
  dummy: [
    { title: '매일매일 코드치기', memo: '취업하장!!', day: 30, result: 'progress', successCheck: false },
    { title: '매일 하루 30분 걷기', memo: '다이어트', day: 100, result: 'progress', successCheck: false },
    { title: '하루 두끼만 먹기', memo: '먹는 양 줄이자', day: 100, result: 'success', successCheck: false },
    { title: '퇴근하고 자지않기', memo: '생체리듬 돌리쟈 :)', day: 50, result: 'fail', successCheck: false },
  ],
  setDummy: (challenge) => {
    set((state) => ({
      dummy: [...state.dummy, {
