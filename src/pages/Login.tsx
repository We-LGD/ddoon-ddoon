  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      ...
      <section className="flex flex-col gap-3">
        <div className="flex items-center justify-between w-[27.375rem]">
          <hr className="border-t-2 w-[38%] border-gray-300" />
          <span className="w-[20%] text-[0.75rem] text-center text-disabledHover">SNS로 시작하기</span>
          <hr className="border-t-2 w-[38%] border-gray-300" />
        </div>
